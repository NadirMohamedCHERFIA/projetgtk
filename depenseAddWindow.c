...
void create_depense_add_window(GtkWidget *butt, gpointer data)
{
    ...
    gtk_window_set_title(GTK_WINDOW(App->window), "Ajouter une depense");
    ...
    gtk_header_bar_set_title(GTK_HEADER_BAR(titleBar), "Ajouter une dépense");
    ...
    //? description label
    App->descriptionlabel = gtk_label_new("Ajouter une nouvelle dépense");

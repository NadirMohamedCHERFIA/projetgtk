...
//     gtk_widget_set_size_request(App->new_user_grid,1140,740);
...
//     //? grid management
//     // gtk_grid_attach(GTK_(App->new_user_grid),App->new_user_form_grid,0,0,4,3);
//     // gtk_grid_attach(GTK_GRID(App->new_user_grid), App->new_user_buttons_grid, 0, 2, 4, 2);
//     // gtk_grid_attach(GTK_GRID(App->new_user_buttons_grid),App->new_user_submit,2,0,2,1);
//     // gtk_grid_attach(GTK_GRID(App->new_user_form_grid),App->new_user_description_hbox,0,4,4,1);
//     gtk_grid_attach(GTK_GRID(App->new_user_grid), App->new_user_username_label, 1,1, 4, 1);
//     gtk_grid_attach(GTK_GRID(App->new_user_grid), App->new_user_submit, 2,1, 4, 1);
